  ...
  static SecondaryColor getSecondaryColor(String themeId) {
    return switch (AppThemeId(themeId)) {
      ...
      AppThemeId.dark => SecondaryColor(
          secondaryColor1: const Color(0xffD3E4FE),
          secondaryColor2: const Color(0xffB7C8E1),
          secondaryColor3: const Color(0xff9CACC5),
          secondaryColor4: const Color(0xff8292AA),
          secondaryColor5: const Color(0xff68788F),
          secondaryColor6: const Color(0xff505F76),
          secondaryColor7: const Color(0xff38485D),
          secondaryColor8: const Color(0xff213145),
          secondaryColor9: const Color(0xff0B1C30),
        ),
      _ => SecondaryColor(
          secondaryColor1: const Color(0xff04201B),
          secondaryColor2: const Color(0xff1A352F),
