  ...
  static NeutralColor getNeutralColor(String themeId) {
    return switch (AppThemeId(themeId)) {
      ...
      AppThemeId.dark => NeutralColor(
          neutralColor1: const Color(0xff263143),
          neutralColor2: const Color(0xff263143),
          neutralColor3: const Color(0xff3C475A),
          neutralColor4: const Color(0xff545F73),
          neutralColor5: const Color(0xff6C778D),
          neutralColor6: const Color(0xff8691A7),
          neutralColor7: const Color(0xffA0ACC2),
          neutralColor8: const Color(0xffA0ACC2),
          neutralColor9: const Color(0xffA0ACC2),
        ),
      _ => NeutralColor(
          neutralColor1: const Color(0xff191C1C),
          neutralColor2: const Color(0xff2E3131),
