  ...
  static TertiaryColor getTertiaryColor(String themeId) {
    return switch (AppThemeId(themeId)) {
      ...
      AppThemeId.dark => TertiaryColor(
          tertiaryColor1: const Color(0xff0D1C2D),
          tertiaryColor2: const Color(0xff233143),
          tertiaryColor3: const Color(0xff39485A),
          tertiaryColor4: const Color(0xff516072),
          tertiaryColor5: const Color(0xff69788C),
          tertiaryColor6: const Color(0xff8392A6),
          tertiaryColor7: const Color(0xff9DACC2),
          tertiaryColor8: const Color(0xff9DACC2),
          tertiaryColor9: const Color(0xffD4E4FA),
        ),
      _ => TertiaryColor(
          tertiaryColor1: const Color(0xff161D1C),
          tertiaryColor2: const Color(0xff2B3231),
